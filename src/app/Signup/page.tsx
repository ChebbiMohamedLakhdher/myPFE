        ...
        <div className="static bg-blue-900 flex flex-col items-center justify-center min-h-screen py-2">
            ...
            <div className="relative">
                ...
                {error && errorMessage === "Email already used" && (
                    <>
                        ...
                        <div className="relative bg-red-700 text-white rounded-lg p-2 text-sm bottom-3 left-0 ">{errorMessage}</div>
                    </>
                )}
            </div>
            ...
            <div className="relative">
                <input
                    ...
                    onFocus={() => Tooltip.show("password-tooltip")} // Show tooltip on focus
                />
                <Tooltip id="password-tooltip" effect="solid">
