...
const Off_table = () => {
  ...
  return (
    ...
    <div className="blog-post1">
      ...
      <div className="blog-post_info1">
        <div className="blog-post_date1">
          <span>Sagar Developer</span>
          <span>Nov 12 2021</span>
        </div>
        <h1 className="blog-post_title1">Lorem ipsum dolor sit amet.</h1>
        <p className="blog-post_text1">
        ...
        <a href="#" className="blog-post_cta1">
          Read More
        </a>
      </div>
    </div>
